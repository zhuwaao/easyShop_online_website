            ...
            <div class="left">
                ...
                <div class="contact">   
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div >
                            <input id="username" type="username" class="@error('email') is-invalid @enderror @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="username" placeholder="@username or email" autofocus>
