    ...
    <section class="login">
        <div class="login_box">
            <div class="left">
                ...
                <div class="contact"> 
                    @if (session('resent'))
                        <div class="alert alert-success" role="alert">{{ _('A fresh verification link has been sent to your email address.') }}</div>
                    @endif

                    <form class="d-inline" method="POST" action="{{ route('verification.resend') }}">
                        @csrf

                        <h3>Before proceeding, please check your email for a verification link.</h3> 
