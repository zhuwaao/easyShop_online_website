            ...
            <div class="left">
                ...
                <div class="contact"> 
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div>
                            <input id="email" type="email" class="@error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" placeholder="example@gmail.com" required autocomplete="email" autofocus>
